...
if __name__ == "__main__":
    ...
    batch.filter(epoch_start=datetime.datetime(2018, 1, 1), stations_exclude=["C51", "C57"])
    ...
    # SPICE
    initial_state_real = spice.get_body_cartesian_state_at_epoch("Ceres", "Sun", "J2000", "NONE", epoch_end)
    # JPL HORIZONS
    ...
    print("metres:")
    spic_init = spice.get_body_cartesian_state_at_epoch("Ceres", "Sun", "J2000", "NONE", epoch_end)
