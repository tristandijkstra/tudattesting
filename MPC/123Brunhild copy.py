...
batch.filter(epoch_start=datetime.datetime(2023, 1, 1), stations_exclude=["C51", "C57"])
...
epoch_start_prop = batch.epoch_start - (86400 * 10)
...
integrator_settings = propagation_setup.integrator.runge_kutta_variable_step_size(
    epoch_start_prop, dt, propagation_setup.integrator.rkf_78, dt, dt, 1.0, 1.0
)
...
parameter_settings = estimation_setup.parameter.initial_states(
    propagator_settings, bodies, [epoch_start]
)
...
print("Kepler:")
keplerElements = element_conversion.cartesian_to_keplerian(parameters_to_estimate.parameter_vector, MUsun)
...
print("ERRORS:")
print(f"a = {(keplerElements[0] - (2.6962986 * 149.6e9))/149.6e9} AU | {(keplerElements[0] - (2.6962986 * 149.6e9))/1000} km")
